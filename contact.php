...
<body>
  ...
  <div class="contact-layout" id="enquiry">
    ...
    <div class="contact-form-wrap">
      ...
      <div id="contactForm">
        <!-- Booking status — always starts as "pending", updated by admin panel to "approved" -->
        <input type="hidden" id="dateStatus" name="dateStatus" value="pending" />
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select class="form-select" id="eventVenue">
              <option value="" disabled selected>Select Venue</option>
              <option>Pier24</option>
              <option>Outdoor Turf</option>
              <option>Both Spaces</option>
            </select>
          </div>
          <div class="form-group">
            ...
            <div class="guest-stepper">
              ...
              <input 
                   ...
                   min="1"
                   max="450"
                   oninput="syncGuestsFromInput(this)"
                   onblur="clampGuestsOnBlur(this)"/>
              <div class="stepper-divider"></div>
              <button
                type="button"
                class="stepper-btn"
        ...
        <button type="button" class="form-submit" id="submitBtn" onclick="submitForm()">
          <span id="submitBtnText">Send Enquiry &rarr;</span>
          <span id="submitBtnLoader" style="display:none;">Sending...</span>
        </button>
        <p class="submit-error" id="submitError" style="display:none;">
          Something went wrong. Please email us directly at
          <a href="mailto:26urbangarden@gmail.com">26urbangarden@gmail.com</a>
        </p>
      </div>
      ...
      <div class="form-success" id="formSuccess">
        ...
        <h3 class="success-title">
          Thank <em style="font-style:italic;color:var(--gold-dark)">You</em>
        </h3>
        <p class="success-body">
          Your enquiry has been received and a confirmation has been sent to
          <strong id="confirmEmail"></strong>. Our events team will reach out
          within 24 hours to discuss your vision and confirm availability.
        </p>
        <div class="success-ref">
          <span class="success-ref-label">Enquiry Reference</span>
          <span class="success-ref-num" id="enquiryRef"></span>
        </div>
        <p class="success-note">
          Didn't receive the email? Check your spam folder or
          <a href="mailto:26urbangarden@gmail.com">contact us directly</a>.
        </p>
  ...
  <div class="faq-section">
    <div class="faq-inner">
      ...
      <div class="faq-item" onclick="toggleFaq(this)">
        ...
        <div class="faq-a">
          <p class="faq-a-inner">
            Pier24 — The Deck can accommodate between 100 and 120 guests for
            an intimate, elevated experience. The Outdoor Turf can host up to
            330 guests. For smaller gatherings or private dining (under 20),
      ...
      <div class="faq-item" onclick="toggleFaq(this)">
        ...
        <div class="faq-a">
          <p class="faq-a-inner">
            ...
            events coordinators. We'd love to show you around both The Deck
